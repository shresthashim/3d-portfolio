...
let projects = [
  {
    image: "textures/chathub.png",
    url: "https://yourchathub.vercel.app/",
  },
  {
    image: "textures/income-expense.png",
    url: "https://income-expense-tracker.cyclic.app/",
  },
  {
    image: "textures/portfolio.png",
    url: "https://ashims.com.np/",
  },
  {
    image: "textures/tictactoe.png",
    url: "https://shresthashim.github.io/tic_tac_toe-game/",
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load("fonts/unione.json", function (font) {
    ...
    const titleGeo = new TextGeometry("AsHim Shrestha", {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load("fonts/helvatica.json", function (font) {
    ...
    const subTitleGeo = new TextGeometry("Web Designer / Full Stack Developer / CS Student", {
      font: font,
      size: 0.018,
      height: 0,
    });
